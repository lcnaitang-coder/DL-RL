# -*- coding: utf-8 -*-
"""
ST-GCN v13.7 Enhanced (with Attention) 模型转换脚本 (Keras -> ONNX)
==============================================================
适配: 带有 Point-wise Channel Attention 的新模型架构
"""
...
RL_PATH = os.path.join(BASE_PATH, "models_rl_v13_6_mstcn_193fps/attention")
SAVE_PATH = RL_PATH 
...
ONNX_AGENT_PATH = os.path.join(SAVE_PATH, "ppo_actor_v13_7.onnx")
...
def convert_fe_v13():
    ...
    print("  - 移植权重 (Including Attention)...")
